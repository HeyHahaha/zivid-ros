...
public:
  ...
  void apply(const SettingsNode&)
  {
    if (type_ == Type::CurrentValue || Zivid::DataModel::HasValidRange<SettingsNode>::value)
    {
      using ValueType = typename SettingsNode::ValueType;
      const auto cfg_id = "cfg." + convertSettingsPathToConfigPath<SettingsRootGroup, SettingsNode>();
...
public:
  ConfigUtilsHeaderGenerator(const std::string& config_class_name)
    ...
    , zivid_settings_to_config_gen(
          config_class_name, ZividSettingsToMinMaxCurrentValueConfigGenerator<SettingsRootGroup>::Type::CurrentValue)
    , zivid_settings_to_min_config_gen(config_class_name,
                                       ZividSettingsToMinMaxCurrentValueConfigGenerator<SettingsRootGroup>::Type::Min)
    , zivid_settings_to_max_config_gen(config_class_name,
                                       ZividSettingsToMinMaxCurrentValueConfigGenerator<SettingsRootGroup>::Type::Max)
  {
  }
  ...
  void apply(const SettingsNode& node)
  {
    ...
    zivid_settings_to_min_config_gen.apply(node);
    zivid_settings_to_max_config_gen.apply(node);
  }
  ...
  ZividSettingsToMinMaxCurrentValueConfigGenerator<SettingsRootGroup> zivid_settings_to_config_gen;
  ZividSettingsToMinMaxCurrentValueConfigGenerator<SettingsRootGroup> zivid_settings_to_min_config_gen;
  ZividSettingsToMinMaxCurrentValueConfigGenerator<SettingsRootGroup> zivid_settings_to_max_config_gen;
};
